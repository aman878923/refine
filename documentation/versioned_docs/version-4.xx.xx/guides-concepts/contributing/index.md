...
description: "Join the Refine community. Comprehensive step-by-step contributing guide for Refine. Learn how to set up your local environment, develop packages, run tests, format code, create changesets, and submit pull requests."
---
